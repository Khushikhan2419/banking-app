  ...
  main.innerHTML = pageHeader("Cards", "Debit & credit cards") + (mine ? `
    <div class="grid cols-2">
      ...
      <div class="card fade-in">
        ...
        <p class="hint">Click a card to flip it and see the back (CVV). Click the eye icon to reveal the full card number whenever you need it — it stays masked until you ask.</p>
      </div>
    </div>
        ...
        <div class="vcard" id="vcard-${c.id}" onclick="flipCard('${c.id}', event)">
          <div class="vcard-face front ${c.card_type}">
            ...
            <div class="vcard-number">
              <span id="vcard-number-${c.id}">${number}</span>
